    ...
    return (
        <div className="relative w-48 grid grid-cols-1">
            {characters.map((char) => {
                ...
                const overlayClass = isOwned && !canPurchaseAgain
                    ? "pointer-events-none before:content-[''] before:bg-black/30 before:absolute before:w-full before:h-full before:left-0 before:top-0 before:rounded-lg before:shadow-[0px_4px_4px_0px_#00000025] before:z-[2]"
                    : "";
